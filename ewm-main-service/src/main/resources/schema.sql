...
ALTER TABLE "comment" ADD CONSTRAINT "comment_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "event" ("id") ON DELETE CASCADE;

ALTER TABLE "comment" ADD CONSTRAINT "comment_author_id_fk" FOREIGN KEY ("author_id") REFERENCES "person" ("id") ON DELETE CASCADE;
